...
# Google AI (Gemini) - Get free key from: https://aistudio.google.com/app/apikey
...
def get_ai_config():
    """Get complete AI configuration for the application"""
    return {
        'default_service': DEFAULT_AI_SERVICE,
        'available_services': list(AI_MODELS.keys()),
        'google': {
            'available': is_service_available('google'),
